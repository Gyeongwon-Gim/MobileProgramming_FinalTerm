...
public class CustomAdapter extends RecyclerView.Adapter<CustomAdapter.ViewHolder> {
    ...
    public CustomAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View holder = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_list, parent, false);
                    ...
                    builder.setItems(strChoiceItems, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int position) {
                            if(position == 0) { //수정하기 / 팝업창
                                ...
                                et_title.setText(toDoItem.getTitle()); //수정시 내용 가져오기
                                et_content.setText(toDoItem.getContent());

                                et_title.setSelection(et_title.getText().length()); //수정시 커서 마지막에 놓기
                                ...
                                btn_ok.setOnClickListener(new View.OnClickListener(){
                                    ...
                                    public void onClick(View v) {
                                        ...
                                        //mDBhelper.InsertTodo(title,content,currentTime); //db에 넣기
